---
title: '트럼프 관세 위법 판결 — 한인 가게 환급 가능한가 2026'
description: '대법원이 2026년 2월 IEEPA 기반 트럼프 관세를 위법 판결했습니다. 한국 수입품을 다루는 한인 사업자가 환급받을 수 있는 조건과 절차를 정리합니다.'
pubDate: '2026-05-17'
tags: ['관세', 'SCOTUS', 'IEEPA', '한인사업자', '환급']
category: 'tax'
ageGroup: 'all'
---
...
```mermaid
flowchart TD
    A[수입품 통관 시 납부한 관세] --> B{근거 법령은?}
    B -->|IEEPA<br/>상호관세 등| C[무효 - 환급 청구 가능]
    B -->|Section 232<br/>철강·알루미늄| D[유효 - 환급 불가]
    B -->|Section 301<br/>중국 일부| E[유효 - 환급 불가]
    C --> F{CBP에 행정 청구<br/>또는 법원 소송}
    F --> G[환급까지 12~18개월 예상]
```
