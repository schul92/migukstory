...
```mermaid
flowchart LR
    A[1단계<br/>FSA ID 발급<br/>studentaid.gov] --> B[2단계<br/>서류 준비<br/>SSN·세금·자산]
    B --> C[3단계<br/>FAFSA 폼 작성<br/>학생→학부모 순]
    C --> D[4단계<br/>IRS DDX 연동<br/>세금 정보 전송]
    D --> E[5단계<br/>대학 20개<br/>리스트 선택]
    E --> F[6단계<br/>서명·제출<br/>SAR 확인]
```
