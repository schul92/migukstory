---
title: '시카고 한인 우버 기사 사망 — 38세 가장의 비극과 한인 부업의 현실'
description: '시카고 가필드파크에서 한인 우버 기사 재슨 조(38)가 손님과 함께 총격으로 사망했습니다. 본업 외 부업으로 우버를 뛰던 한인의 안타까운 사연과 부업 종사자의 현실을 정리했습니다.'
pubDate: '2026-05-17'
tags: ['시카고', '한인', '우버', '재슨조', '한인부업']
category: 'community'
ageGroup: 'all'
---
...
```mermaid
flowchart TD
    A[한인 부업 동기] --> B[높은 주거비<br/>대도시 거주]
    A --> C[자녀 학자금<br/>사립대 등록금]
    A --> D[부모 부양<br/>한국 가족 송금]
    A --> E[유동성 확보<br/>창업·이직 대비]
    B --> F[라이드셰어<br/>야간·주말 운행]
    C --> F
    D --> F
    E --> F
    F --> G[안전 사각지대<br/>총격·강도 위험 노출]
```
